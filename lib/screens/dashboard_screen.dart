            ...
            child: Column(
              ...
              children: [
                    ...
                    child: Column(
                      children: [
                        ...
                        AnimatedSwitcher(
                          ...
                          child: Text(
                            appUser.totalPoints.toString(),
                            key: ValueKey(appUser.totalPoints),
                ...
                StreamBuilder<List<Challenge>>(
                  stream: firestore.streamChallenges(),
                  builder: (context, snap) {
                    ...
                    return Column(
                      children: challenges.map((c) {
                        final completed = c.completedBy.contains(appUser.userId);
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(16),
                            border: Border.all(
                              color: completed ? Colors.greenAccent : Colors.blueAccent,
                              width: 2,
                            ),
                            boxShadow: [
                              BoxShadow(
                                color: (completed ? Colors.greenAccent : Colors.blueAccent).withOpacity(0.3),
                                blurRadius: 12,
                              ),
                            ],
                          ),
